...
class UserLocationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_location" do
    assert_difference("UserLocation.count") do
      post user_locations_url, params: { user_location: { city: @user_location.city, latitude: @user_location.latitude, longitude: @user_location.longitude } }
    end
  ...
  test "should update user_location" do
    patch user_location_url(@user_location), params: { user_location: { city: @user_location.city, latitude: @user_location.latitude, longitude: @user_location.longitude } }
